...
library(gridExtra); library(SPEI); library(tidyr); library(tibble); library(sp); library(skimr); library(cft); library(stringr); library(ggpubr); library(lemon); library(ggfortify); library(extRemes);library(sp);library(terra)
...
Park = "MORA"  
Koppen = "MORA_27" #PARK_##
SiteName = "MORA" #"MORA-Paradise VC" #optional - set at SiteID if don't want to use
set.seed(50)
...
local_rss_dir <- paste0(local_rss_dir,Koppen)
...
OutDir <- "C:/Users/arunyon/3D Objects/Local-files/Git-repos/CCRP_automated_climate_futures/PARK/MORA_27/"
