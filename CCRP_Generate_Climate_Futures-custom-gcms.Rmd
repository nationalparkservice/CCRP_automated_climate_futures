...
OutDir <- "C:/Users/achildress/Documents/Git-repos/CCRP_automated_climate_futures/PARK/WHSA/"
# OutDir <- 'C:/Users/achildress/Documents/RCF_Testing/WHSA/'
load(paste0(OutDir,"input-data/Final_Environment.RData"))

FutureSubset <- c("Least change", "Hot Wet", "Hot Dry")
CFs = FutureSubset 
custom_GCMs = c("inmcm4.rcp45", "MIROC-ESM.rcp85","HadGEM2-ES365.rcp85") # In order as FutureSubset

CF_abbreviation <- "Custom-CFs"
# WB_GCMs <- subset(WB_GCMs, CF %in% CFs)

colors2<- c("light green", "blue", "red")
...
source(here::here("scripts/custom-gcms", "Plot_Table-custom-CFs.R")) 
