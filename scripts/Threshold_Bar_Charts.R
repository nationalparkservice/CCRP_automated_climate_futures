...
ggsave("CFmeansStar-scatter.png", width = PlotWidth, height = PlotHeight, path = OutDir)
...
ggsave("CFmeansStar-IndivCircled-scatter.png", width = PlotWidth, height = PlotHeight, path = OutDir)
