...
Site<- as_Spatial(Site) # objects must be Spatial (sp) to work with raster package (cannot be sf)
cell <- cellFromXY(maca, Site) # find grid cell park centroid lies within
