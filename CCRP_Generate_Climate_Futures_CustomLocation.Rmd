...
library(gridExtra); library(SPEI); library(tidyr); library(tibble); library(sp); library(skimr); library(cft); library(stringr); library(ggpubr); library(lemon); library(ggfortify); library(extRemes);library(data.table);library(sp)
...
Park = "NIOB"  
SiteName = "NIOB-East" #optional - set at SiteID if don't want to use
Lat = 42.735558
Lon = -99.743792
set.seed(50)
