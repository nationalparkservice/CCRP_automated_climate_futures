...
local_rss_dir <- 'C:/Users/gknowlton/OneDrive - DOI/Documents/RSS/' # local directory where you want this repo copied. Should be something like 'C:/Users/adillon/Documents/RSS/'. Next lines create folder for park
...
if(centroids_csv == "Y") {
  source(here::here("scripts", "download_Tercek_csvs.R"), local = knitr::knit_global())
} else {
...
source(here::here("scripts", "RSS_MACA_Plot_Table_Creation.R"), local = knitr::knit_global()) # Requires "PARK_init_parsed.RData"; Output = "PARK_lat_long_Final_Environment.RData". 

source(here::here("scripts", "Plotting_Functions.R"), local = knitr::knit_global())


source(here::here("scripts", "RSS_MACA_Scatter and diagnostic.R"), local = knitr::knit_global()) # Creates scatter and diagnostic plots. Outputs to Figs MACA folder. 
```
...
colors2<- c("#6EB2D4", "#CA0020") # Select pair of climate futures - WarmWet/HotDry
...
source(here::here("scripts", "RSS_Plotting_Bar_Charts.R")) # Requires "PARK_lat_long_Final_Environment.RData". Outputs plots and Excel Workbook 

source(here::here("scripts", "get_params.R"))

source(here::here("scripts","Daily_WB_Model.R"))

#source(here::here("scripts", "Daily_WB_batch_v2.R"))

#source(here::here("scripts", "RSS_MACA_drought_char.R"))
...
```{r WarmDry/HotWet, message=FALSE, warning=FALSE, include=FALSE, results=HIDE}
# Specify Climate Futures
...
colors2<- c("#05689F","#F6B294") # Select pair of climate futures - HotWet/WarmDry
